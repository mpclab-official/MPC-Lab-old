// __class.js
// This is a router file that contains the code for the class page.
...
router.get("/:language/class", checkPageRedirect, (req, res) => {
  getUserData(req.session.userID, (err, data) => {
    ...
    Classroom.getClassroomsByUserId(req.session.userID).then((classrooms) => {
      ...
      res.render(path.join(config.path, "page", "class"), {

// __my_edit.js
// This is a router file that contains the code for the user edit page.
...
router.route("/:language/my/edit").get(checkPageRedirect, (req, res) => {
  getUserData(req.session.userID, (err, data) => {
    ...
    Auth.getUserById(data.UID, (err, data) => {
      ...
      res.render(path.join(config.path, "page", "my-edit"), {
